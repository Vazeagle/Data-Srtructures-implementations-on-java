...
public class MerosD
{
    ...
    static long maxInterpolation=Long.MIN_VALUE;//μεγιστος χρονος αρχικοποιειται με το μιν του long
    ...
    public static void times(){
       ...
       MerosA.mergeSort(MerosA.initialArray);
        for(int i=0; i<500; i++){  //500anazhthseis!
    ...
    moLineral = sumLineral/500;
    
    moBinary=sumBinary/500;
    
    moInterpolation=sumInterpolation/500;
    
    moRBTree=sumRBTree/500;
    ...
    sb.append('\n');
     ...
     sb.append(minLineral);
     sb.append(';');
     sb.append(minBinary);
     sb.append(';');
     sb.append(minInterpolation);
     sb.append(';');
     sb.append(minRBTree);
     sb.append('\n');
     ...
     sb.append(maxLineral);
     sb.append(';');
     sb.append(maxBinary);
     sb.append(';');
     sb.append(maxInterpolation);
     sb.append(';');
     sb.append(maxRBTree);
     sb.append('\n');
